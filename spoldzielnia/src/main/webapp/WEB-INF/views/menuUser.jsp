...
<table>
	...
	<sec:authorize ifAllGranted="ROLE_ADMIN">
		...
		<tr><td><a href="/app/admin/bills"><spring:message code="bills.menu"/></a></td></tr>
		<tr><td><a href="/app/admin/countersVerify"><spring:message code="menu.admin.verify"/></a></td></tr>
	</sec:authorize>
